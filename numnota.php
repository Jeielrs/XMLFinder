            ...
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#">
                  ...
                  NF's separadas por CNPJ
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" href="numnota.php">
                  <span data-feather="file"></span>
                  NF's separadas pelo número <span class="sr-only">(current)</span>
                </a>
              </li>
          ...
          <br />
            ...
            <div class="col-md 10">
            	<table class='table table-dark table-striped table-bordered table-center'>
            		...
            		<th class='text-center'>CNPJ Cliente</th><th class='text-center'>Link</th></tr>
            	<?php
 					$numdigi = $_POST['numnota']; 
 					$n = 1;		
 					foreach (glob('notas/*.xml') as $xmlfile) {
 						...
 						if ($nota == $numdigi){
 							echo "<tr><td class='text-center'>".$n."</td><td class='text-center'>".$xmlfile."</td>
 								<td class='text-center'>".$cnpj."</td><td class='text-center'><a href='".$xmlfile."' target='_blank'>ABRIR</a></td></tr>";
 							$n++;
 							}	

            }
            //if ($n=1){
            //  echo "<h6>Não foi encontrada nenhuma nota com esse número ".$numdigi."</h6>";
            //}
 				?>	
 				</table>
            </div>
